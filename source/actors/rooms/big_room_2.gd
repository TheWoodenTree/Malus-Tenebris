...
@onready var shriek_player = $ShriekPlayer
@onready var distant_crash_player = $DistantCrashPlayer
@onready var lever = $Lever
@onready var stone_door_wall = $StoneDoorWall
...
func stone_door_progress(index):
	...
	if index == 0:
		play_crash_sound()
		light = stone_door_wall.get_node("LeverCountLight/Mesh").mesh
